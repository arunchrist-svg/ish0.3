...
export function toWriterDraft(
  ...
  return {
    ...
    subjectC: outreach.subjectC ?? undefined,
    emailBody: outreach.emailBody ? normalizeEmailBody(outreach.emailBody) : undefined,
    emailBodyB: outreach.emailBodyB ? normalizeEmailBody(outreach.emailBodyB) : undefined,
    emailBodyC: outreach.emailBodyC ? normalizeEmailBody(outreach.emailBodyC) : undefined,
    chosenSubjectKey: outreach.chosenSubjectKey ?? undefined,
    chosenBodyKey: outreach.chosenBodyKey ?? undefined,
