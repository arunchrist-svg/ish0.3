...
import {
  formatHiGreetingLine,
  ISH_BULK_FIRST_NAME_TOKEN,
  resolveIshGreetingName,
} from "@/lib/email/ish-greeting";

export { ISH_BULK_FIRST_NAME_TOKEN, formatHiGreetingLine, resolveIshGreetingName };
...
function prasanthGreeting(first: string): string {
