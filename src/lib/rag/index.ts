...
function filterPackKnowledge(
  ...
  const keywords = [
    ...
    context.campaignMode === "year_round" ? "occasion" : undefined,
    context.campaignMode === "year_round" ? "program" : undefined,
    context.campaignMode === "year_round" ? "opening" : undefined,
    context.campaignMode === "year_round" ? "birthday" : undefined,
    context.campaignMode === "year_round" ? "pantry" : undefined,
    "tone",
    "compliance",
    "cta",
