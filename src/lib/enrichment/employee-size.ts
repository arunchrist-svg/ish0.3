...
export const EMPLOYEE_SIZE_BANDS = [
  ...
  },
  {
    id: "small",
    label: "Small scale",
    sublabel: "11-100 people",
    min: 11,
    max: 100,
    searchHint: "small scale",
    apolloRanges: ["11,50", "51,100"],
  },
  {
    id: "medium",
    label: "100-200",
    sublabel: "100-200 people",
    min: 100,
    max: 200,
    searchHint: "medium-sized",
    apolloRanges: ["101,200"],
  },
  {
    id: "large",
    label: "200-500",
    sublabel: "200-500 people",
    min: 200,
    max: 500,
    searchHint: "large scale",
    apolloRanges: ["201,500"],
  },
  {
    id: "enterprise",
    label: "500-2000",
    sublabel: "500-2000 people",
    min: 500,
    max: 2000,
    searchHint: "large scale",
    apolloRanges: ["501,1000", "1001,2000"],
  },
  {
    id: "corporate",
    label: "2000+",
    sublabel: "2000+ people",
    min: 2001,
    max: null,
    searchHint: "large scale",
    apolloRanges: ["2001,5000", "5001,10000", "10001"],
  },
] as const;
...
const SCALE_PATTERNS: { id: EmployeeSizeBandId; pattern: RegExp }[] = [
  { id: "corporate", pattern: /\bMNC\b|\bconglomerate\b/i },
  { id: "enterprise", pattern: /\blarge[\s-]+scale\b|\blarge[\s-]+industr(?:y|ies)\b/i },
