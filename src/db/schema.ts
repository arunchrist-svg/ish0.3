...
export const campaigns = pgTable("campaigns", {
  ...
  buyingContext: text("buying_context"),
...
export const leadResearch = pgTable("lead_research", {
  ...
  outreachHook:    text("outreach_hook"),
...
export const leadOutreach = pgTable("lead_outreach", {
  ...
  subjectC:          text("subject_c"),
  emailBody:         text("email_body"),
  emailBodyB:        text("email_body_b"),
  emailBodyC:        text("email_body_c"),
  chosenSubjectKey:  text("chosen_subject_key").default("A"),
  chosenBodyKey:     text("chosen_body_key").default("A"),
