...
export function ScoutingControlBar({
  ...
  return (
    <div className="flex flex-wrap items-center gap-x-3 gap-y-2 border-b border-brand-border bg-white px-5 py-2.5">
      <CitySelector
        cities={cities}
      ...
      <div className="hidden h-5 w-px shrink-0 bg-brand-border sm:block" aria-hidden />
        ...
        <div className="flex w-full shrink-0 flex-wrap items-center gap-2 sm:ml-auto sm:w-auto">
          <button
            ...
            className={cn(
              ...
              canFetchCompanies
                ? "bg-brand-black shadow-[var(--shadow-brand)] hover:opacity-90"
                : "cursor-not-allowed bg-brand-ink-faint opacity-50",
            )}
          >
          ...
          <button
            ...
            className="flex shrink-0 items-center gap-1 rounded-xl border border-brand-border bg-white px-3 py-1.5 text-[12px] font-semibold text-brand-ink shadow-[var(--shadow-brand-sm)] transition-all hover:bg-brand-app disabled:opacity-50"
          >
          ...
          <button
            ...
            className="flex shrink-0 items-center rounded-xl border border-brand-border bg-white px-3 py-1.5 text-[12px] font-semibold text-brand-ink shadow-[var(--shadow-brand-sm)] transition-all hover:bg-brand-app disabled:opacity-50"
          >
          ...
          <button
            ...
            className={cn(
              ...
              selectedCount > 0
                ? "bg-brand-green shadow-[var(--shadow-brand)] hover:opacity-90"
                : "cursor-not-allowed bg-brand-ink-faint opacity-50",
            )}
          >
